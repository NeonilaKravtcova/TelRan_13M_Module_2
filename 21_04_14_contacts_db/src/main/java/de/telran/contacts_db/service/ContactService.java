...
public class ContactService {
    ...
    public List<Contact> searchAllContactsContainingPattern(String pattern){
        return new ArrayList<>(contactRepo.findContactsByNameIsContainingIgnoreCaseOrLastNameIsContainingIgnoreCase(pattern, pattern));
    }
}
